info( logger, "MODELO_CARTOLA::forca dos clubes" )


info( logger, "MODELO_CARTOLA::forca dos clubes - ataque" )

rodada <- max(dados_cartola$rodada_id)
...
info( logger, "MODELO_CARTOLA::forca dos clubes - meio" )
...
info( logger, "MODELO_CARTOLA::forca dos clubes - laterais" )
...
info( logger, "MODELO_CARTOLA::forca dos clubes - zagueiros" )
...
info( logger, "MODELO_CARTOLA::forca dos clubes - goleiros" )
